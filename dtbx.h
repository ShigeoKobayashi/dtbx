...
/* in lusolver.cpp */
/* MAT_INDEX(i,j,M) calculates square MATRIX index */ 
#define MAT_INDEX(i,j,M)   ((i)*(M)+j)
DTX_EXPORT(int)  DtxLuDecompose(double *A, double *scales, int *index, int n);
DTX_EXPORT(void) DtxLuSolve(double *x, double *A, double *b, int *ps, int n);
